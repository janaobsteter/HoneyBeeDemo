...
est = pd.read_csv("EstsfsOutput_rate6/output-" + str(cycle) + "-pvalues.txt", sep = " ", header = None, skiprows = 8)
...
namefile.to_csv("EstsfsOutput_rate6/AncestralAllele" + str(cycle) + "_rate6.csv", index=None)
